...
def main(window):
    ...
    fire.on()
    objects = [*floor, Block(0, HEIGHT - block_size * 2, block_size), Block(500, HEIGHT - block_size * 4, block_size), fire]
    offset_x = 0
    scroll_area_width = 200
    run = True
    while run:
        clock.tick(FPS)  # regulate the frame rate of whlie loop
